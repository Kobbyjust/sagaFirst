...
//import { deleteEngineerings, listEngineerings, saveEngineerings } from '../actions/productActions';
import Axios from 'axios';
import { deleteEngineerings, listEngineerings, saveEngineerings } from '../../actions/AdminActions/addEngineering';

  
   
function EngineeringsScreen(props) {
    ...
    const dispatch = useDispatch();
       ...
       const submitHandler = (e) =>{
           e.preventDefault();
           dispatch(saveEngineerings(name, price, type, image, description, countInStock));

       }
       const deleteHandler = (product) => {
        dispatch(deleteEngineerings(product.name));
      };
...
export default EngineeringsScreen;