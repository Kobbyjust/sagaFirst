...
import { deleteComputerAccessories, listComputerAccessories, saveComputerAccessories } from '../../actions/AdminActions/addComputerAccessoriesScreen';



  
   
function ComputerAccessoriesScreen(props) {
    ...
    const dispatch = useDispatch();
       ...
       useEffect(() => {
        ...
        dispatch(listComputerAccessories());
        return () =>{
            //
        }; 
       ...
       const submitHandler = (e) =>{
           e.preventDefault();
           dispatch(saveComputerAccessories(name, price, type, image, description, countInStock));

       }
       const deleteHandler = (product) => {
        dispatch(deleteComputerAccessories(product.name));
      };
...
export default ComputerAccessoriesScreen;