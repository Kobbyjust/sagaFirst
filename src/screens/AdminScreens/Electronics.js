...
import { deleteElectronics, listElectronics, saveElectronics } from '../../actions/AdminActions/addElectronic';
...
function ProvisionsScreen(props) {
    ...
    const dispatch = useDispatch();
       ...
       const submitHandler = (e) =>{
           e.preventDefault();
           dispatch(saveElectronics(name, price, type, image, description, countInStock));

       }
       const deleteHandler = (product) => {
        dispatch(deleteElectronics(product.name));
      };
